			...
			<div class = "panel-body">
				...
				<div style = "height:300px; width:800px;">
					...
					<div style = "float:left; margin-left:10px;">
						...
						<h3 style = "color:#00ff00;"><?php echo "RUPEE ".$fetch['price'].".00";?></h3>
					</div>
				</div>
				<br style = "clear:both;" />
				<div class = "well col-md-4">
					<form method = "POST" enctype = "multipart/form-data">
						<div class = "form-group">
							...
							<input type = "text" class = "form-control" name = "firstname" onkeyup="textonly(this)" required = "required" />
						</div>
						<div class = "form-group">
							<label>Middlename</label>
							<input type = "text" class = "form-control" onkeyup="text1only(this)" name = "middlename"  />
						</div>
						<div class = "form-group">
							<label>Lastname</label>
							<input type = "text" class = "form-control" name = "lastname" onkeyup="text2only(this)" required = "required" />
						</div>
						<div class = "form-group">
							<label>Address</label>
						...
						<div class = "form-group">
							...
							<input type = "text" class = "form-control" onkeyup="numberonly(this)" name = "contactno" required = "required" />
						</div>
						<div class = "form-group">
